...
| **Análise de Produto, CRM e Eficiência de Marketing** | [Y.Afisha-CRM-Analytics](https://github.com/wspdata/Y.Afisha-CRM-Analytics) | Python | projeto de analise de dados de produto, vendas e marketing para apoiar decisões de alocação de orçamento e otimização de investimentos. O objetivo foi a construção de métricas estratégicas de CRM e Marketing Analytics, incluindo análise de coortes, LTV, CAC e ROI. |
